...
public class PlaylistAddDto {
    ...
    public PlaylistAddDto(Integer playlistId, String playlistName, String playlistDescription, String playlistCover, List<TrackDetailDto> tracks, Integer memberSeq) {
